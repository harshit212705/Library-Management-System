...
<table>
  ...
  $results_per_page = 20; //setting results per page
  ...
  if ($total > 0){
    $i = $start_from + 1;
    //displaying data according to the page number
	 ...
	 echo "<br><br>";
      ...
      if ($i == $page){
        ...
        echo "<h2>";
            echo "<a href='all_books.php?page=".$i."'"; // creating link  for specific pages and linking them to numbers
            echo ">".$i.".&nbsp;&nbsp;&nbsp;&nbsp;"."</a>";
            echo "</h2>";
            }
            else{
